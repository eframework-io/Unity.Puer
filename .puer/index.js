...
//#region Mono
const PuerBehaviour = CS.EFramework.Unity.Puer.PuerBehaviour
CS.EFramework.Unity.Puer.PuerBehaviour = new Proxy(class {
    constructor(proxy) {
        this.CProxy = proxy
...
CS.UnityEngine.MonoBehaviour = CS.EFramework.Unity.Puer.PuerBehaviour
//#endregion